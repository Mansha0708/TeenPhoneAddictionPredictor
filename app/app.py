...
if st.button("Predict Addiction Level", type="primary"):
    ...
    all_gender_categories = ["Female", "Male", "Other"]
    all_school_grade_categories = ["6th", "7th", "8th", "9th", "10th", "11th", "12th", "Other"]
    all_purpose_categories = ["Communication", "Education", "Entertainment", "Gaming", "Other", "Social Media"]
    ...
    expected_ohe_cols = [
        ...
        'School_Grade_11th', 'School_Grade_12th', 'School_Grade_7th', 'School_Grade_8th', 'School_Grade_9th', # Assuming '6th' or '10th' or 'Other' was dropped
        'School_Grade_Other', 'School_Grade_10th', 'School_Grade_6th', # Add other possible grades if they exist in training data but not in user's provided list
        'Phone_Usage_Purpose_Education', 'Phone_Usage_Purpose_Gaming', 'Phone_Usage_Purpose_Other', 'Phone_Usage_Purpose_Social Media', # Assuming 'Communication' or 'Entertainment' was dropped
        'Phone_Usage_Purpose_Entertainment' # Add if 'Entertainment' was a category and not dropped
    ]

    # Filter the expected_ohe_cols to only include those that are actually in the user's provided list of 35 features
    # This ensures we only create columns that the model expects.
    final_expected_ohe_cols = [
        'Gender_Male', 'Gender_Other',
        'School_Grade_11th', 'School_Grade_12th', 'School_Grade_7th', 'School_Grade_8th', 'School_Grade_9th',
        'Phone_Usage_Purpose_Education', 'Phone_Usage_Purpose_Gaming', 'Phone_Usage_Purpose_Other', 'Phone_Usage_Purpose_Social Media'
    ]
    ...
    # Debugging: Print the final input DataFrame's columns and shape
    st.write("---")
    ...
    try:
        ...
        st.warning("Please ensure your 'addiction_model.pkl' was trained with the exact same 35 features and order as expected by this app. Check the 'Debugging Info' above.")
